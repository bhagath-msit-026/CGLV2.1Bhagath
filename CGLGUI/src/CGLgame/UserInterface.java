...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	private Board db=new Board();
	private Board bn=new Board();
	...
	**********************************************************************************************/
	...
	public void Display(Pane p) {
		...
		for (int r = 0; r < db.size1; r++) {
			for (int c = 0; c < db.size2; c++) {
				if (db.getBoard()[r][c]==true) {
					Rectangle rect = new Rectangle(6,6,Color.BLUE);
					rect.relocate(r*5, c*5);
	...
	private void loadImageData() {
		try {
			// Your code goes here......
			db=new Board( boardSizeWidth, boardSizeHeight,"./test01");
		}
		catch (Exception e)  {
